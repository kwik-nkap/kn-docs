...
# Image name is ghcr.io/kwik-nkap/base-with-canvas-puppeteer-node:21
...
# docker build -t ghcr.io/kwik-nkap/base-with-canvas-puppeteer-node:21 -f canvas-base-pipeline-image.Dockerfile .
# docker build --platform linux/amd64 -t ghcr.io/kwik-nkap/base-with-canvas-puppeteer-node:21 -f canvas-base-pipeline-image.Dockerfile .
